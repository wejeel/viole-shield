...
String recovery1 = recovery.getText();
String answer1 = answer.getText();
if(username1.equals("")||password1.equals("")||email1.equals("")||recovery1.equals("")||answer1.equals(""))
{
JOptionPane.showMessageDialog(null,"You have some empty field(s)");
}
...
else
{
 try
    {       
        conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost/violeshield", "root","root");
        Statement st = (Statement) conn.createStatement();
        String insert = "INSERT INTO account_table VALUES ('" +username1+ "', '" +password1+ "', '" +email1+ "', '" +recovery1+ "', '" +answer1+ "')";
    ...
    private void initComponents() {
        ...
        recovery.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        ...
        answer.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(24, 24, 24)
                                .addComponent(recovery, javax.swing.GroupLayout.PREFERRED_SIZE, 195, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGroup(jPanel1Layout.createSequentialGroup()
